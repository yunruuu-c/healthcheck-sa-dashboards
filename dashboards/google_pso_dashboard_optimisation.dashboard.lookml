...
- dashboard: google_pso__dashboard_optimisation_
    ...
    body_text: |-
      <nav style="font-size: 18px; padding: 5px 10px 0 10px; height: 60px">
            <a style="padding: 5px; border-bottom: solid 1px #4285F4; float: left; line-height: 40px;" href="/dashboards/healthcheck::google_pso__performance_metrics">Performance Metrics</a>
              ...
              <a style="padding: 5px; border-top: solid 1px #4285F4; border-left: solid 1px #4285F4; border-right: solid 1px #4285F4; border-radius: 5px 5px 0 0; float: left; line-height: 40px; font-weight: bold;" href="/healthcheck::google_pso__dashboard_optimisation_?">Dashboard Optimisation</a>
            </nav>
    row: 0
    col: 1
    width: 12
  ...
  - name: Dashboard Title
    ...
    type: field_filter
    default_value: Goodwill Calculator
    allow_multiple_values: true
    required: true
    ui_config:
      type: dropdown_menu
